{{-- @if (Auth::user()->role == 'Admin') --}}
    ...
    <body class="">
        ...
        <div class="wrapper">
                                ...
                                <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                    <li class=" ">
                                        ...
                                        <ul id="user" class="iq-submenu collapse" data-parent="#otherpage">
                                            <li class="">
                                                <a href="{{ asset('templates/admin/assetser-profile.html') }}">
                                                    <i class="las la-minus"></i><span>User Profile</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ asset('templates/admin/assetser-add.html') }}">
                                                    <i class="las la-minus"></i><span>User Add</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="{{ asset('templates/admin/assetser-list.html') }}">
                        ...
                        <div class="card border-none">
                            <div class="card-body p-0">
                                <div class="sidebarbottom-content">
                                    <div class="image"><img
                                            src="{{ asset('templates/admin/assets/images/layouts/side-bkg.png') }}"
            ...
            <div class="iq-top-navbar mt-4">
                <div class="iq-navbar-custom">
                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                        <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                            <i class="ri-menu-line wrapper-menu"></i>
                            <a href="../backend/index.html" class="header-logo">
                                <img src="{{ asset('templates/admin/assets/images/logo.png" class="img-fluid rounded-normal') }}"
                                    alt="logo">
                                ...
                                <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                    <li class="nav-item nav-icon dropdown">
                                        <a href="#" class="search-toggle dropdown-toggle btn border add-btn"
                                            ...
                                            aria-expanded="false">
                                            <img src="{{ asset('templates/admin/assets/images/small/flag-01.png') }}"
                                            ...
                                            <div class="card shadow-none m-0">
                                                <div class="card-body p-3">
                                                    <a class="iq-sub-card" href="#"><img
                                                            src="{{ asset('templates/admin/assets/images/small/flag-02.png') }}"
                                                            alt="img-flag" class="img-fluid mr-2">French</a>
                                                    <a class="iq-sub-card" href="#"><img
                                                            src="{{ asset('templates/admin/assets/images/small/flag-03.png') }}"
                                                            alt="img-flag" class="img-fluid mr-2">Spanish</a>
                                                    <a class="iq-sub-card" href="#"><img
                                                            src="{{ asset('templates/admin/assets/images/small/flag-04.png') }}"
                                                            alt="img-flag" class="img-fluid mr-2">Italian</a>
                                                    <a class="iq-sub-card" href="#"><img
                                                            src="{{ asset('templates/admin/assets/images/small/flag-05.png') }}"
                                                            alt="img-flag" class="img-fluid mr-2">German</a>
                                                    <a class="iq-sub-card" href="#"><img
                                                            src="{{ asset('templates/admin/assets/images/small/flag-06.png') }}"
                                                    ...
                                                    <div class="px-3 pt-0 pb-0 sub-card">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="">
                                                                    <img class="avatar-50 rounded-small"
                                                                        src="{{ asset('templates/admin/assets/images/user/01.jpg') }}"
                                                                        alt="01">
                                                                </div>
                                                        ...
                                                        <a href="#" class="iq-sub-card">
                                                            <div
                                                                ...
                                                                <div class="">
                                                                    <img class="avatar-50 rounded-small"
                                                                        src="{{ asset('templates/admin/assets/images/user/02.jpg') }}"
                                                                        alt="02">
                                                                </div>
                                                                <div class="media-body ml-3">
                                                                    <div
                                                        ...
                                                        <a href="#" class="iq-sub-card">
                                                            <div class="media align-items-center cust-card py-3">
                                                                <div class="">
                                                                    <img class="avatar-50 rounded-small"
                                                                        src="{{ asset('templates/admin/assets/images/user/03.jpg') }}"
                                                                        alt="03">
                                                                </div>
                                                                <div class="media-body ml-3">
                                                                    <div
                                            ...
                                            <div class="card shadow-none m-0">
                                                <div class="card-body p-0 text-center">
                                                    <div class="media-body profile-detail text-center">
                                                        <img src="{{ asset('templates/admin/assets/images/page-img/profile-bg.jpg') }}"
