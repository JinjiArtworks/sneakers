    ...
    <div class="bg-gray-100 flex-1 p-6 md:mt-16">
        ...
        <div class="card col-span-2 xl:col-span-1">
            <div class="card-header flex justify-between">
                <p class="text-2xl text-black ">Ubah Data Alergi</p>
            </div>
            <div class="p-6">
                <form method="POST"
                    action="{{ route('resources.update-alergi', ['id' => $alergi->id]) }} "enctype="multipart/form-data">
                    @csrf
                    {{ method_field('put') }}
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" min="1"
                            ...
                            placeholder="Masukkan Nama Alergi " required value="{{ $alergi->nama }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea type="text" name="deskripsi" min="1"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  w-full p-3"
                            placeholder="Masukkan deskripsi " required>{{ $alergi->deskripsi }}</textarea>
                    </div>
                    <div class="mb-4">
                        ...
                        <textarea type="text" name="efek" min="1"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  w-full p-3"
                            placeholder="Masukkan Efek Alergi" required>{{ $alergi->efek }}</textarea>
                    </div>
                    <button type="submit"
