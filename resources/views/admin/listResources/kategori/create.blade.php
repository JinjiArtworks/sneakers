    ...
    <div class="bg-gray-100 flex-1 p-6 md:mt-16">
        ...
        <div class="card col-span-2 xl:col-span-1">
            <div class="card-header flex justify-between">
                <p class="text-2xl text-black ">Tambah Kategori Produk</p>
            </div>
            <div class="p-6">
                <form method="POST" action="/store-kategori" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                    ...
                    <button type="submit"
                        class="add-kategori text-white btn-shadow hover:bg-green-400  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2 ">Submit</button>
                </form>
...
@section('script')
    <script>
        $('.add-kategori').click(function(event) {
